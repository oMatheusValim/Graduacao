...
# # Obs: O método aplicaJuros incrementa o juros dado
...
# [4] Aplica juros
# [5] Ver saldo
# [6] Armazene as informações das contas em um arquivo
# [7] Leia as informações das contas de um arquivo
# [9] Sair

# Utilize a biblioteca pickle para salvar e acessar o arquivo binário
...
def menu():
    ...
    while True:
        ...
        if opcao == 1:
            ...
            with open('contas.bin', 'wb') as arq:
                pickle.dump(contas, arq)
                    
        
        elif opcao == 7:
            with open('contas.bin', 'rb') as arq:
