...
A nota deste trabalho será utilizada como nota substitutiva para os alunos que optarem entregar até o dia **04/12/2024** .

## Objetivo
Realizar a limpeza de dados na base de dados disponibilizada no e-disciplina.
